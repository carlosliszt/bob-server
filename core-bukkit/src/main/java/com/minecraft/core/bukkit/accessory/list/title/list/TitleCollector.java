...
public enum TitleCollector {
    ...
    SINCE("Desde",
            new TitleAccessory(TitleAccessory.TitleCategory.GERAL, "fjre3", "§eDesde §b{0}",
                    "Desde", "title.since", Rank.ULTRA_PLUS, new ItemStack(TitleAccessory.TitleCategory.GERAL.getMaterial()),
    ...
    CLAN("Clan",
            new TitleAccessory(TitleAccessory.TitleCategory.GERAL, "fjre4", "§eMembro de {0}",
                    "Clan", "title.clan", Rank.ULTRA_PLUS, new ItemStack(TitleAccessory.TitleCategory.GERAL.getMaterial()),
    ...
    MEDAL("Sua medalha",
            new TitleAccessory(TitleAccessory.TitleCategory.GERAL, "fjre5", "{0}",
                    "Medalha", "title.medal", Rank.ULTRA_PLUS, new ItemStack(TitleAccessory.TitleCategory.GERAL.getMaterial()),
