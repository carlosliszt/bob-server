...
public enum GameType {
    ...
    SOLO(2, 15, Columns.BRIDGE_SOLO_WINS, Columns.BRIDGE_SOLO_LOSSES, Columns.BRIDGE_SOLO_KILLS, Columns.BRIDGE_SOLO_DEATHS, Columns.BRIDGE_SOLO_POINTS, Columns.BRIDGE_SOLO_ROUNDS, Columns.BRIDGE_SOLO_WINSTREAK, Columns.BRIDGE_SOLO_MAX_WINSTREAK),
