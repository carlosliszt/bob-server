...
public enum Tables {
    ...
    ACCOUNT("accounts", Columns.USERNAME, Columns.NICK_OBJECTS, Columns.RANKS, Columns.PERMISSIONS, Columns.TAGS, Columns.CLANTAGS, Columns.MEDALS, Columns.PUNISHMENTS, Columns.CLAN, Columns.FLAGS, Columns.PREMIUM, Columns.FIRST_LOGIN, Columns.LAST_LOGIN, Columns.ADDRESS, Columns.BANNED, Columns.MUTED),
    ...
    OTHER("other", Columns.NICK, Columns.LAST_NICK, Columns.TAG, Columns.CLANTAG, Columns.LANGUAGE, Columns.PREFIXTYPE, Columns.MEDAL, Columns.PREFERENCES, Columns.SKIN, Columns.BLOCKEDS),
